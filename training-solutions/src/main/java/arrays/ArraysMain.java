...
public class ArraysMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(arraysMain.sameTempValues(new double[]{2, 2, 2}, new double[]{2, 1, 2}));

        System.out.println(arraysMain.sameTempValuesDaylight(new double[]{1, 2}, new double[]{1, 2, 3}));

        int[] winner = new int[]{2, 3, 5, 7};
        int[] stake = new int[]{7, 5, 3, 2};
        ...
        System.out.println(arraysMain.wonLottery(new int[]{1, 5, 9}, new int[]{1, 5, 7}));
    }
}
